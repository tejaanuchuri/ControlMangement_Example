...
// Control ManagementDlg.cpp : implementation file
//

#include "pch.h"
#include "framework.h"
#include "Control Management.h"
#include "Control ManagementDlg.h"
...
CControlManagementDlg::CControlManagementDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_CONTROL_MANAGEMENT_DIALOG, pParent)
...
BEGIN_MESSAGE_MAP(CControlManagementDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_EN_CHANGE(IDC_EDIT1, &CControlManagementDlg::OnEnChangeEdit1)
	ON_BN_CLICKED(IDC_CHECK1, &CControlManagementDlg::OnBnClickedCheck1)
END_MESSAGE_MAP()


// CControlManagementDlg message handlers
...
void CControlManagementDlg::OnEnChangeEdit1()
{
...
void CControlManagementDlg::OnBnClickedCheck1()
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE);
